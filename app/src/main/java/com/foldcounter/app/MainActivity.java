...
public class MainActivity extends AppCompatActivity {
    ...
    // 统一缓动曲线
    private static final PathInterpolator SPRING   = new PathInterpolator(0.34f, 1.56f, 0.64f, 1.0f);
    private static final PathInterpolator EASE_OUT = new PathInterpolator(0.16f, 1.0f, 0.30f, 1.0f);
    private static final PathInterpolator EASE_IN  = new PathInterpolator(0.4f,  0.0f, 1.0f,  1.0f);
    ...
    @Override protected void onPause() {
        super.onPause();
        unregisterReceiver(rxUpdate);
        unregisterReceiver(rxMilestone);
    }
